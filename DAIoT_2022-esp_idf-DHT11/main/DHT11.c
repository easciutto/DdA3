...
int DHTgpio = 23;				// my default DHT pin = 22
float humidity = 0.;
float temperature = 0.;
...
//	ESP_LOGI( TAG, "Response = %d", uSec );
  ...
  //	printf("...\n");
	for( int k = 0; k < 40; k++ ) {//40
		...
		uSec = getSignalLevel( 50, 0 );//50
		if( uSec<0 ) {return DHT_TIMEOUT_ERROR;}

		// -- check to see if after >70us rx data is a 0 or a 1

		uSec = getSignalLevel(1000 , 1 );//1000
		if( uSec<0 ) {return DHT_TIMEOUT_ERROR;}
